...
@section("title","ajouter sous administrateur")
@section("content")
      <!-- Begin Page Content -->
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            position: relative;" >
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Ajouter  Sous Administrateur</h1>
                </div>
                <form class="user" action="{{route("sousadmin.store")}}" method="POST">
                    @csrf
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Nom de utilisateur" name="nom_utilisateur" value="{{@old("nom_utilisateur")}}">
